...
class SpaceRex(Enemy):
    ...
    def update(self):
        ...
        if self.crystal_spawn_timer >= 180:  
            self.crystal_spawn_timer = 0
...
class Demolishyah(Enemy):
    def __init__(self, path, stage=1):
        ...
        self.base_damage_timer = 0 if stage == 4 else None  
        self.regen_amount = 5 if stage == 4 else 0  
